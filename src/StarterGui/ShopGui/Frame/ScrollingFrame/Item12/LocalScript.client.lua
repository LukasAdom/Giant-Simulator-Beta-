...
script.Parent.MouseButton1Click:connect(function()
	...
	script.Parent.Parent.Parent.ViewPortFolder.ViewportFrameToothBruh.Visible = false
	...
	script.Parent.Parent.Parent.ViewPortFolder.ViewportFrameLukasSoul.Visible = true
end)
